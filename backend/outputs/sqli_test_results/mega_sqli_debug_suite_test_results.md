...
| 3 | `python/003_IN_BAND_vuln_whitelist_computed_but_unused.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 4 | `python/004_NONE_safe_placeholder_list_in.py` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 5 | `python/005_IN_BAND_vuln_joined_in_list.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 6 | `python/006_NONE_safe_limit_offset_int_bounds.py` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
...
| 13 | `python/013_NONE_safe_db_value_parameterized.py` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 14 | `python/014_NONE_safe_static_executescript.py` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
...
| 17 | `python/017_NONE_safe_enum_parameterized.py` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 18 | `python/018_IN_BAND_vuln_alias_to_execute.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 19 | `python/019_NONE_safe_dict_map_table.py` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
...
| 22 | `javascript/022_NONE_safe_parameterized_query.js` | SAFE / NONE | SAFE / NONE | 0.0145 | ✅ |
...
| 25 | `javascript/025_NONE_safe_whitelist_order_by.js` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
| 26 | `javascript/026_IN_BAND_vuln_raw_order_by.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 27 | `javascript/027_NONE_safe_placeholder_in_list.js` | SAFE / NONE | SAFE / NONE | 0.0002 | ✅ |
...
| 30 | `java/030_NONE_safe_prepared_statement.java` | SAFE / NONE | SAFE / NONE | 0.0203 | ✅ |
...
| 35 | `php/035_IN_BAND_vuln_mysqli_concat.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 36 | `php/036_NONE_safe_prepared_stmt.php` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 37 | `php/037_BLIND_vuln_count_bool.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9658 | ✅ |
...
| 40 | `php/040_IN_BAND_vuln_raw_order_by.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |