...
| 11 | `javascript/011_SAFE_db_all_params.js` | SAFE / NONE | SAFE / NONE | 0.0017 | ✅ |
...
| 14 | `javascript/014_IN_BAND_raw_order.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 31 | `php/031_SAFE_pdo_prepare_execute.php` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
...
| 37 | `php/037_BLIND_count_bool.php` | VULNERABLE / BLIND | VULNERABLE / IN_BAND | 1.0 | ❌ |
| 38 | `php/038_SECOND_ORDER_saved_filter.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9999 | ✅ |
| 39 | `php/039_SAFE_db_value_as_param.php` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
