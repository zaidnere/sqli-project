...
| 3 | `python/003_BLIND_flask_permission_check.py` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
...
| 6 | `javascript/006_SAFE_express_orders_repository.js` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
...
| 10 | `javascript/010_SAFE_reports_query_builder.js` | SAFE / NONE | SAFE / NONE | 0.0086 | ✅ |
...
| 15 | `php/015_SAFE_PdoInventoryRepository.php` | SAFE / NONE | SAFE / NONE | 0.0419 | ✅ |
| 16 | `php/016_IN_BAND_mysqli_customer_search.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 17 | `php/017_BLIND_FeatureFlagService.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9238 | ✅ |
