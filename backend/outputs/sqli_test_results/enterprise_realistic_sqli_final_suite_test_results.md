...
| 20 | `javascript/020_IN_BAND_joined_ids_bulk_lookup.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9945 | ✅ |
...
| 23 | `java/023_BLIND_login_statement.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9974 | ✅ |
...
| 27 | `java/027_BLIND_permission_count.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9976 | ✅ |
...
| 30 | `java/030_SECOND_ORDER_config_condition.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
