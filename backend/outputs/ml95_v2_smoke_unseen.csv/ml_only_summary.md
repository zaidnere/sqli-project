...
- Threshold: **0.3000** from `metadata.threshold`
- Total: **128**
...
- ML attack distribution: `{'NONE': 30, 'IN_BAND': 48, 'BLIND': 24, 'SECOND_ORDER': 26}`

## Failures

- `javascript/034_SAFE_unseen_case_bnagwhn.js` expected `SAFE / NONE` got `VULNERABLE / SECOND_ORDER` risk `0.9392`
- `javascript/037_SAFE_unseen_case_zqxcycv.js` expected `SAFE / NONE` got `VULNERABLE / SECOND_ORDER` risk `0.4206`
