...
| 18 | `javascript/018_SECOND_ORDER_stored_query_runner.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 1.0 | ✅ |
| 19 | `javascript/019_SAFE_db_loaded_value_as_param.js` | SAFE / NONE | SAFE / NONE | 0.006 | ✅ |
| 20 | `javascript/020_SAFE_plain_service_no_sql.js` | SAFE / NONE | SAFE / NONE | 0.006 | ✅ |
| 21 | `java/021_SAFE_prepared_select.java` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
| 22 | `java/022_SAFE_prepared_update.java` | SAFE / NONE | SAFE / NONE | 0.019 | ✅ |
...
| 28 | `java/028_SECOND_ORDER_stored_query.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 1.0 | ✅ |
| 29 | `java/029_SAFE_db_loaded_value_as_param.java` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
| 30 | `java/030_SAFE_plain_no_sql.java` | SAFE / NONE | SAFE / NONE | 0.0039 | ✅ |
