...
- Total: **40**
- Binary ML accuracy: **34/40** (85.00%)
- Full ML label+type accuracy: **31/40** (77.50%)
- Precision / Recall / F1: **0.8000 / 1.0000 / 0.8889**
- FP / FN: **6 / 0**
- Expected attack distribution: `{'NONE': 16, 'IN_BAND': 12, 'BLIND': 8, 'SECOND_ORDER': 4}`
- ML attack distribution: `{'NONE': 10, 'IN_BAND': 13, 'SECOND_ORDER': 5, 'BLIND': 12}`
