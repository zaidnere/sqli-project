...
| 2 | `python/002_IN_BAND_vuln_raw_order_by.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
| 3 | `python/003_IN_BAND_vuln_whitelist_computed_but_unused.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 7 | `python/007_IN_BAND_vuln_raw_limit_offset.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 14 | `python/014_NONE_safe_static_executescript.py` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 15 | `python/015_IN_BAND_vuln_executescript_fstring.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 22 | `javascript/022_NONE_safe_parameterized_query.js` | SAFE / NONE | SAFE / NONE | 0.0181 | ✅ |
...
| 35 | `php/035_IN_BAND_vuln_mysqli_concat.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9981 | ✅ |
