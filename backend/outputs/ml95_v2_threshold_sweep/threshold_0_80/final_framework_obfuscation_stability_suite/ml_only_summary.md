...
- Total: **64**
- Binary ML accuracy: **42/64** (65.62%)
- Full ML label+type accuracy: **35/64** (54.69%)
- Precision / Recall / F1: **0.6136 / 0.8438 / 0.7105**
- FP / FN: **17 / 5**
- Expected attack distribution: `{'NONE': 32, 'IN_BAND': 16, 'BLIND': 8, 'SECOND_ORDER': 8}`
- ML attack distribution: `{'IN_BAND': 21, 'SECOND_ORDER': 7, 'BLIND': 16, 'NONE': 20}`
