...
- Total: **40**
- Binary ML accuracy: **27/40** (67.50%)
- Full ML label+type accuracy: **24/40** (60.00%)
- Precision / Recall / F1: **0.6486 / 1.0000 / 0.7869**
- FP / FN: **13 / 0**
- Expected attack distribution: `{'NONE': 16, 'IN_BAND': 12, 'BLIND': 8, 'SECOND_ORDER': 4}`
- ML attack distribution: `{'IN_BAND': 20, 'SECOND_ORDER': 5, 'BLIND': 12, 'NONE': 3}`
...
- `known_good_sqli_detection_suite/php/031_SAFE_pdo_prepare_execute.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.4907`
- `known_good_sqli_detection_suite/php/032_SAFE_array_whitelist_order.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.4907`
- `known_good_sqli_detection_suite/php/039_SAFE_db_value_as_param.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.4907`
