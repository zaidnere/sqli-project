...
- Total: **28**
- Binary ML accuracy: **25/28** (89.29%)
- Full ML label+type accuracy: **24/28** (85.71%)
- Precision / Recall / F1: **1.0000 / 0.8125 / 0.8966**
- FP / FN: **0 / 3**
- Expected attack distribution: `{'NONE': 12, 'IN_BAND': 8, 'SECOND_ORDER': 3, 'BLIND': 5}`
- ML attack distribution: `{'NONE': 15, 'SECOND_ORDER': 4, 'IN_BAND': 4, 'BLIND': 5}`
