...
- Threshold: **0.9800** from `cli`
- Total: **128**
- Binary ML accuracy: **120/128** (93.75%)
- Full ML label+type accuracy: **112/128** (87.50%)
- Precision / Recall / F1: **1.0000 / 0.9167 / 0.9565**
- FP / FN: **0 / 8**
- Expected attack distribution: `{'NONE': 32, 'IN_BAND': 32, 'BLIND': 32, 'SECOND_ORDER': 32}`
- ML attack distribution: `{'NONE': 40, 'IN_BAND': 40, 'BLIND': 24, 'SECOND_ORDER': 24}`
...
- `php/113_BLIND_unseen_case_feckgmb.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/114_BLIND_unseen_case_cxdaobq.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/115_BLIND_unseen_case_yfuzqzz.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/116_BLIND_unseen_case_byhsayx.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/117_BLIND_unseen_case_euvpwoq.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/118_BLIND_unseen_case_fqsyywl.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/119_BLIND_unseen_case_tvapbfk.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
- `php/120_BLIND_unseen_case_ztkdkie.php` expected `VULNERABLE / BLIND` got `SAFE / NONE` risk `0.9717`
