...
| 11 | `java/011_SAFE_SpringOrderRepository.java` | SAFE / NONE | VULNERABLE / IN_BAND | 0.989 | ❌ |
| 12 | `java/012_IN_BAND_legacyStatementSearch.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.989 | ✅ |
| 13 | `java/013_BLIND_LoginServiceStatement.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.989 | ✅ |
| 14 | `java/014_SECOND_ORDER_AuditArchiveService.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.989 | ✅ |
...
| 18 | `php/018_SECOND_ORDER_ProfileAudit.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9326 | ✅ |
...
- Actual: `VULNERABLE / IN_BAND`
- Risk score: `0.989`
- Explanation: High risk score (99%) from ML model.
