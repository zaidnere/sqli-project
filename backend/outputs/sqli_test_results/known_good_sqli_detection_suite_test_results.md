...
| 4 | `python/004_IN_BAND_raw_order_by.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9975 | ✅ |
...
| 11 | `javascript/011_SAFE_db_all_params.js` | SAFE / NONE | SAFE / NONE | 0.0002 | ✅ |
| 12 | `javascript/012_SAFE_allowlisted_order.js` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 13 | `javascript/013_IN_BAND_template_where.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 14 | `javascript/014_IN_BAND_raw_order.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9998 | ✅ |
...
| 19 | `javascript/019_SAFE_db_value_as_param.js` | SAFE / NONE | SAFE / NONE | 0.0089 | ✅ |
...
| 33 | `php/033_IN_BAND_mysqli_concat.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 34 | `php/034_IN_BAND_raw_order.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9968 | ✅ |
| 35 | `php/035_IN_BAND_raw_ids_implode.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 36 | `php/036_BLIND_login_raw.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
| 37 | `php/037_BLIND_count_bool.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
