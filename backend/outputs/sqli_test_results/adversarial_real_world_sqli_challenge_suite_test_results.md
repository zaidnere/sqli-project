...
| 6 | `python/006_IN_BAND_execute_alias.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9997 | ✅ |
...
| 9 | `javascript/009_SAFE_sequelize_replacements_decoy.js` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 10 | `javascript/010_IN_BAND_replacements_exist_template_used.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 11 | `javascript/011_BLIND_rows_length_permission.js` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9995 | ✅ |
| 12 | `javascript/012_SECOND_ORDER_cache_order_clause.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 1.0 | ✅ |
| 13 | `javascript/013_SAFE_sqlite_params_spread_decoy.js` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 14 | `javascript/014_IN_BAND_alias_bind_raw_table.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9848 | ✅ |
...
| 18 | `java/018_IN_BAND_jdbc_concat_with_param_decoy.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 19 | `java/019_BLIND_exists_helper.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
| 20 | `java/020_SECOND_ORDER_stored_sql_helper.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9999 | ✅ |
