...
- Total: **64**
- Binary ML accuracy: **43/64** (67.19%)
- Full ML label+type accuracy: **36/64** (56.25%)
- Precision / Recall / F1: **0.6279 / 0.8438 / 0.7200**
- FP / FN: **16 / 5**
- Expected attack distribution: `{'NONE': 32, 'IN_BAND': 16, 'BLIND': 8, 'SECOND_ORDER': 8}`
- ML attack distribution: `{'IN_BAND': 20, 'SECOND_ORDER': 7, 'BLIND': 16, 'NONE': 21}`
