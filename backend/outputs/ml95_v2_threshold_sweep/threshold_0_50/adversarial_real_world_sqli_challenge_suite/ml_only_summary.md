...
- Threshold: **0.5000** from `cli`
- Total: **32**
- Binary ML accuracy: **21/32** (65.62%)
- Full ML label+type accuracy: **19/32** (59.38%)
- Precision / Recall / F1: **0.6667 / 0.9000 / 0.7660**
- FP / FN: **9 / 2**
- Expected attack distribution: `{'NONE': 12, 'IN_BAND': 8, 'BLIND': 8, 'SECOND_ORDER': 4}`
- ML attack distribution: `{'SECOND_ORDER': 8, 'BLIND': 10, 'IN_BAND': 9, 'NONE': 5}`
