...
- Total: **40**
- Binary ML accuracy: **29/40** (72.50%)
- Full ML label+type accuracy: **23/40** (57.50%)
- Precision / Recall / F1: **0.7576 / 0.8929 / 0.8197**
- FP / FN: **8 / 3**
- Expected attack distribution: `{'NONE': 12, 'IN_BAND': 9, 'BLIND': 8, 'SECOND_ORDER': 11}`
- ML attack distribution: `{'IN_BAND': 17, 'BLIND': 7, 'SECOND_ORDER': 9, 'NONE': 7}`
