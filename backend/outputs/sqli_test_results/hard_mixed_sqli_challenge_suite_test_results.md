...
|---:|---|---|---|---:|---|
| 1 | `python/001_SAFE_exact_helper_whitelist_order_by.py` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
...
| 5 | `python/005_SAFE_static_migration_executescript.py` | SAFE / NONE | SAFE / NONE | 0.0062 | ✅ |
| 6 | `python/006_IN_BAND_fstring_where_direct.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
...
| 9 | `python/009_IN_BAND_executescript_dynamic.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
...
| 22 | `javascript/022_SAFE_set_whitelist_order.js` | SAFE / NONE | SAFE / NONE |  | ✅ |
...
| 25 | `javascript/025_SAFE_db_loaded_value_as_param.js` | SAFE / NONE | SAFE / NONE | 0.0013 | ✅ |
...
| 30 | `javascript/030_IN_BAND_db_exec_template.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9991 | ✅ |
| 31 | `javascript/031_BLIND_count_bool.js` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
...
| 36 | `javascript/036_SECOND_ORDER_saved_segment.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9981 | ✅ |
| 37 | `javascript/037_SECOND_ORDER_cached_fragment.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 1.0 | ✅ |
| 38 | `javascript/038_SECOND_ORDER_db_loaded_order.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9981 | ✅ |
| 39 | `javascript/039_SECOND_ORDER_stored_query.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 40 | `javascript/040_SECOND_ORDER_saved_filter_builder.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9492 | ✅ |
| 41 | `java/041_SAFE_prepared_statement_basic.java` | SAFE / NONE | SAFE / NONE | 0.0002 | ✅ |
| 42 | `java/042_SAFE_resultset_next_prepared_bool.java` | SAFE / NONE | SAFE / NONE |  | ✅ |
| 43 | `java/043_SAFE_set_contains_order_by.java` | SAFE / NONE | SAFE / NONE |  | ✅ |
| 44 | `java/044_SAFE_db_value_reused_as_param.java` | SAFE / NONE | SAFE / NONE |  | ✅ |
| 45 | `java/045_SAFE_numeric_bounds_limit.java` | SAFE / NONE | SAFE / NONE |  | ✅ |
| 46 | `java/046_IN_BAND_statement_concat_where.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9488 | ✅ |
| 47 | `java/047_IN_BAND_whitelist_unused_raw_order.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 48 | `java/048_IN_BAND_raw_order.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 49 | `java/049_IN_BAND_joined_ids.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 50 | `java/050_IN_BAND_raw_limit_offset.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 51 | `java/051_BLIND_count_next_statement.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
| 52 | `java/052_BLIND_login_statement.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
| 53 | `java/053_BLIND_permission_raw.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
| 54 | `java/054_BLIND_is_admin_raw.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
| 55 | `java/055_BLIND_token_raw.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
| 56 | `java/056_SECOND_ORDER_getstring_fragment.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 57 | `java/057_SECOND_ORDER_saved_note_condition.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9978 | ✅ |
| 58 | `java/058_SECOND_ORDER_db_loaded_order.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 59 | `java/059_SECOND_ORDER_stored_query_run.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 60 | `java/060_SECOND_ORDER_cached_config_where.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9052 | ✅ |
| 61 | `php/061_SAFE_pdo_prepare_execute.php` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
| 62 | `php/062_SAFE_array_whitelist_order.php` | SAFE / NONE | SAFE / NONE | 0.0018 | ✅ |
...
| 69 | `php/069_IN_BAND_raw_order.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9988 | ✅ |
| 70 | `php/070_IN_BAND_pdo_query_raw.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 78 | `php/078_SECOND_ORDER_profile_audit_where.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9996 | ✅ |
| 79 | `php/079_SECOND_ORDER_stored_sql_run.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 80 | `php/080_SECOND_ORDER_config_fragment.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9972 | ✅ |