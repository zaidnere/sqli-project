...
- Full ML label+type accuracy: **17/32** (53.12%)
- Precision / Recall / F1: **0.6333 / 0.9500 / 0.7600**
- FP / FN: **11 / 1**
- Expected attack distribution: `{'NONE': 12, 'IN_BAND': 8, 'BLIND': 8, 'SECOND_ORDER': 4}`
- ML attack distribution: `{'SECOND_ORDER': 8, 'BLIND': 10, 'IN_BAND': 12, 'NONE': 2}`
...
- `adversarial_real_world_sqli_challenge_suite/javascript/013_SAFE_sqlite_params_spread_decoy.js` expected `SAFE / NONE` got `VULNERABLE / SECOND_ORDER` risk `0.8235`
...
- `adversarial_real_world_sqli_challenge_suite/php/025_SAFE_pdo_allowlist_clamp_decoys.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.4907`
- `adversarial_real_world_sqli_challenge_suite/php/029_SAFE_db_value_bound_param.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.4907`
...
- `adversarial_real_world_sqli_challenge_suite/php/032_BLIND_time_based_raw.php` expected `VULNERABLE / BLIND` got `VULNERABLE / IN_BAND` risk `0.4907`
- `adversarial_real_world_sqli_challenge_suite/python/001_SAFE_nested_allowlist_decoys.py` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.8522`
