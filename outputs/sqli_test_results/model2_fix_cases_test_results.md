...
| 10 | `python/010_NONE_safe_parameterized_boolean.py` | SAFE / NONE | SAFE / NONE | 0.0023 | ✅ |
...
| 13 | `python/013_NONE_safe_db_value_parameterized.py` | SAFE / NONE | SAFE / NONE | 0.0004 | ✅ |
...
| 17 | `python/017_NONE_safe_enum_parameterized.py` | SAFE / NONE | SAFE / NONE | 0.0274 | ✅ |
...
| 27 | `javascript/027_NONE_safe_placeholder_in_list.js` | SAFE / NONE | SAFE / NONE | 0.0001 | ✅ |
...
| 36 | `php/036_NONE_safe_prepared_stmt.php` | SAFE / NONE | SAFE / NONE | 0.0227 | ✅ |
