...
| 15 | `python/015_IN_BAND_vuln_executescript_fstring.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.995 | ✅ |
...
| 18 | `python/018_IN_BAND_vuln_alias_to_execute.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
| 19 | `python/019_NONE_safe_dict_map_table.py` | SAFE / NONE | SAFE / NONE |  | ✅ |
| 20 | `python/020_IN_BAND_vuln_dynamic_table_raw.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9989 | ✅ |
...
| 23 | `javascript/023_BLIND_vuln_boolean_count.js` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9956 | ✅ |
| 24 | `javascript/024_SECOND_ORDER_vuln_cached_fragment.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9981 | ✅ |
| 25 | `javascript/025_NONE_safe_whitelist_order_by.js` | SAFE / NONE | SAFE / NONE | 0.0017 | ✅ |
...
| 28 | `javascript/028_IN_BAND_vuln_joined_ids.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 31 | `java/031_BLIND_vuln_boolean_login.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9948 | ✅ |
| 32 | `java/032_SECOND_ORDER_vuln_stored_note.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9909 | ✅ |
...
| 36 | `php/036_NONE_safe_prepared_stmt.php` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
