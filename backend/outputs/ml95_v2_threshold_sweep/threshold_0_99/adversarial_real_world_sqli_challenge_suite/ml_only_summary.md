...
- Total: **32**
- Binary ML accuracy: **25/32** (78.12%)
- Full ML label+type accuracy: **24/32** (75.00%)
- Precision / Recall / F1: **0.8095 / 0.8500 / 0.8293**
- FP / FN: **4 / 3**
- Expected attack distribution: `{'NONE': 12, 'IN_BAND': 8, 'BLIND': 8, 'SECOND_ORDER': 4}`
- ML attack distribution: `{'SECOND_ORDER': 6, 'BLIND': 10, 'NONE': 11, 'IN_BAND': 5}`
...
- `adversarial_real_world_sqli_challenge_suite/javascript/014_IN_BAND_alias_bind_raw_table.js` expected `VULNERABLE / IN_BAND` got `SAFE / NONE` risk `0.9848`
