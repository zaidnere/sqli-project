...
- Precision / Recall / F1: **0.7353 / 0.8929 / 0.8065**
- FP / FN: **9 / 3**
- Expected attack distribution: `{'NONE': 12, 'IN_BAND': 9, 'BLIND': 8, 'SECOND_ORDER': 11}`
- ML attack distribution: `{'IN_BAND': 18, 'BLIND': 7, 'SECOND_ORDER': 9, 'NONE': 6}`
...
- `enterprise_realistic_sqli_final_suite/javascript/015_SAFE_report_params_variable.js` expected `SAFE / NONE` got `VULNERABLE / SECOND_ORDER` risk `0.6265`
...
- `enterprise_realistic_sqli_final_suite/php/031_SAFE_pdo_order_repository.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.4907`
