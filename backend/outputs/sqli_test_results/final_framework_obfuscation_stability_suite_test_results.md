...
| 10 | `python/010_SECOND_ORDER_huge_stored_sql_late_sink.py` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9998 | ✅ |
...
| 15 | `python/015_SAFE_empty_logic_file.py` | SAFE / NONE | SAFE / NONE | 0.022 | ✅ |
| 16 | `python/016_SAFE_broken_syntax_no_crash.py` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 17 | `javascript/017_SAFE_express_sequelize_replacements.js` | SAFE / NONE | SAFE / NONE | 0.0009 | ✅ |
| 18 | `javascript/018_IN_BAND_sequelize_template_raw.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 19 | `javascript/019_SAFE_knex_where_params.js` | SAFE / NONE | SAFE / NONE | 0.0009 | ✅ |
...
| 23 | `javascript/023_SAFE_params_variable_and_decoys.js` | SAFE / NONE | SAFE / NONE | 0.0009 | ✅ |
...
| 26 | `javascript/026_SECOND_ORDER_huge_stored_query.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9614 | ✅ |
| 27 | `javascript/027_SAFE_hebrew_comments.js` | SAFE / NONE | SAFE / NONE | 0.0009 | ✅ |
| 28 | `javascript/028_BLIND_feature_count_helper.js` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.997 | ✅ |
| 29 | `javascript/029_SAFE_multi_query_file.js` | SAFE / NONE | SAFE / NONE | 0.0009 | ✅ |
...
| 34 | `java/034_IN_BAND_spring_jdbctemplate_concat.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.979 | ✅ |
| 35 | `java/035_SAFE_jpa_native_query_params.java` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
| 36 | `java/036_IN_BAND_jpa_native_query_concat.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9997 | ✅ |
...
| 42 | `java/042_SECOND_ORDER_huge_stored_query.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9022 | ✅ |
...
| 46 | `java/046_IN_BAND_multi_query_one_unsafe.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
| 47 | `java/047_SAFE_only_comments.java` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 48 | `java/048_SAFE_broken_syntax_no_crash.java` | SAFE / NONE | SAFE / NONE | 0.0243 | ✅ |
| 49 | `php/049_SAFE_laravel_db_select_bindings.php` | SAFE / NONE | SAFE / NONE | 0.0007 | ✅ |
...
| 53 | `php/053_BLIND_mysqli_login.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
| 54 | `php/054_SECOND_ORDER_pdo_saved_filter_helper.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 55 | `php/055_SAFE_placeholder_list.php` | SAFE / NONE | SAFE / NONE | 0.0007 | ✅ |
| 56 | `php/056_IN_BAND_implode_raw_ids.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
| 57 | `php/057_SAFE_huge_pdo_repo.php` | SAFE / NONE | SAFE / NONE | 0.0007 | ✅ |
| 58 | `php/058_SECOND_ORDER_huge_stored_sql.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9 | ✅ |
| 59 | `php/059_SAFE_hebrew_comments.php` | SAFE / NONE | SAFE / NONE | 0.0007 | ✅ |
| 60 | `php/060_BLIND_permission_fetch_assoc.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
| 61 | `php/061_SAFE_multi_query_file.php` | SAFE / NONE | SAFE / NONE | 0.0007 | ✅ |
