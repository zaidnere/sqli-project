...
- Precision / Recall / F1: **0.7500 / 1.0000 / 0.8571**
- FP / FN: **4 / 0**
- Expected attack distribution: `{'NONE': 6, 'IN_BAND': 4, 'BLIND': 4, 'SECOND_ORDER': 4}`
- ML attack distribution: `{'IN_BAND': 5, 'BLIND': 7, 'SECOND_ORDER': 4, 'NONE': 2}`

## Failures

- `realistic_long_sqli_suite/java/011_SAFE_SpringOrderRepository.java` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.9504`
- `realistic_long_sqli_suite/php/015_SAFE_PdoInventoryRepository.php` expected `SAFE / NONE` got `VULNERABLE / IN_BAND` risk `0.6436`
