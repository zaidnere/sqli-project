...
| 15 | `javascript/015_SAFE_db_loaded_value_param.js` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 16 | `javascript/016_SAFE_sequelize_replacements_decoy.js` | SAFE / NONE | SAFE / NONE | 0.0009 | ✅ |
| 17 | `java/017_SAFE_named_parameter_jdbc_template.java` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 18 | `java/018_IN_BAND_named_parameter_concat_email.java` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 19 | `java/019_SECOND_ORDER_real_config_condition.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 1.0 | ✅ |
| 20 | `java/020_BLIND_time_based_sleep.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 1.0 | ✅ |
...
| 26 | `php/026_IN_BAND_direct_mysqli_customer_search.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |
...
| 29 | `php/029_SECOND_ORDER_real_saved_filter.php` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9998 | ✅ |
| 30 | `php/030_SAFE_db_value_as_param.php` | SAFE / NONE | SAFE / NONE | 0.0007 | ✅ |
| 31 | `php/031_BLIND_time_based_sleep.php` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9 | ✅ |
| 32 | `php/032_IN_BAND_callable_query_alias_raw.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9967 | ✅ |