...
| 3 | `python/003_NONE_safe_helper_pick_allowed_order_by.py` | SAFE / NONE | SAFE / NONE | 0.0004 | ✅ |
...
| 10 | `javascript/010_IN_BAND_vuln_joined_ids_js.js` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 15 | `javascript/015_BLIND_vuln_count_bool_js.js` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9956 | ✅ |
| 16 | `javascript/016_NONE_safe_count_bool_js.js` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
| 17 | `java/017_BLIND_vuln_resultset_next.java` | VULNERABLE / BLIND | VULNERABLE / BLIND | 0.9948 | ✅ |
...
| 21 | `javascript/021_SECOND_ORDER_vuln_cached_fragment_js.js` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9981 | ✅ |
| 22 | `javascript/022_NONE_safe_db_value_param_js.js` | SAFE / NONE | SAFE / NONE | 0.25 | ✅ |
| 23 | `java/023_SECOND_ORDER_vuln_resultset_getstring.java` | VULNERABLE / SECOND_ORDER | VULNERABLE / SECOND_ORDER | 0.9909 | ✅ |
...
| 26 | `php/026_NONE_safe_fetch_assoc_param_reuse.php` | SAFE / NONE | SAFE / NONE | 0.08 | ✅ |
| 27 | `javascript/027_NONE_safe_set_has_order_by_js.js` | SAFE / NONE | SAFE / NONE | 0.0073 | ✅ |
