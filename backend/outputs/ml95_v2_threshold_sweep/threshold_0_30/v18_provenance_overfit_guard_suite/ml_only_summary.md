...
- Full ML label+type accuracy: **12/20** (60.00%)
- Precision / Recall / F1: **0.6875 / 0.8462 / 0.7586**
- FP / FN: **5 / 2**
- Expected attack distribution: `{'NONE': 7, 'IN_BAND': 8, 'SECOND_ORDER': 2, 'BLIND': 3}`
- ML attack distribution: `{'NONE': 4, 'SECOND_ORDER': 4, 'BLIND': 3, 'IN_BAND': 9}`
...
- `v18_provenance_overfit_guard_suite/javascript/008_SAFE_config_value_as_bound_parameter.js` expected `SAFE / NONE` got `VULNERABLE / SECOND_ORDER` risk `0.3876`
