...
| 2 | `python/002_IN_BAND_vuln_whitelist_computed_but_raw_used.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 12 | `python/012_IN_BAND_vuln_raw_limit_offset.py` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9999 | ✅ |
...
| 26 | `php/026_NONE_safe_fetch_assoc_param_reuse.php` | SAFE / NONE | SAFE / NONE | 0.0004 | ✅ |
...
| 32 | `php/032_IN_BAND_vuln_array_map_but_raw_used.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 1.0 | ✅ |