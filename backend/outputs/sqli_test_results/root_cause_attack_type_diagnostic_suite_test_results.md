...
| 15 | `javascript/015_SAFE_db_loaded_value_param.js` | SAFE / NONE | SAFE / NONE | 0.006 | ✅ |
| 16 | `javascript/016_SAFE_sequelize_replacements_decoy.js` | SAFE / NONE | SAFE / NONE | 0.006 | ✅ |
| 17 | `java/017_SAFE_named_parameter_jdbc_template.java` | SAFE / NONE | SAFE / NONE | 0.0071 | ✅ |
...
| 26 | `php/026_IN_BAND_direct_mysqli_customer_search.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
| 27 | `php/027_IN_BAND_laravel_raw_concat.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |
...
| 32 | `php/032_IN_BAND_callable_query_alias_raw.php` | VULNERABLE / IN_BAND | VULNERABLE / IN_BAND | 0.9 | ✅ |